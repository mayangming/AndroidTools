...
//            mDrawable = new BitmapDrawable(XCApplication.getInstance().getResources(), b);
//            mDrawable.setBounds(
...
//                try {
//                    InputStream is =
//                            XCApplication.getInstance().getContentResolver().openInputStream(mContentUri);
...
//            } else {
//                try {
//                    drawable = ContextCompat.getDrawable(XCApplication.getInstance(), mResourceId);
//                    drawable.setBounds(
//                            0, 0, drawable.getIntrinsicWidth(), drawable.getIntrinsicHeight()
//                    );
//                } catch (Exception e) {
